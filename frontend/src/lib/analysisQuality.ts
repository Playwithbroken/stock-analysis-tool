...
export const getAnalysisQualityState = (quality?: AnalysisDataQuality) => {
  if (quality?.insufficient_signal) {
    return {
      ...
      detail: "Kurs- oder Fundamentaldaten fehlen. Analyse erneut laden, bevor du Score, Trigger oder Positionsgröße verwendest.",
  ...
  if (quality?.degraded) {
    return {
      ...
      title: "Datensatz nur teilweise verfügbar",
      detail: "Der schnelle Kurs-Snapshot ersetzt keinen vollständigen Abruf. Signale beobachten und vor einer Umsetzung erneut bestätigen.",
  ...
  return {
    level: "full" as const,
    label: "Vollständiger Abruf",
    title: "Datensatz vollständig geladen",
    detail: "Kurs-, Fundamental- und Analysedaten wurden für dieses Dossier abgerufen.",
