...
const LOCAL_SEARCH_ALIASES: Record<string, string> = {
  ...
  bitcoinetf: "iShares Bitcoin Trust ETF (IBIT)",
  ...
  cardano: "Cardano USD (ADA-USD)",
  ada: "Cardano USD (ADA-USD)",
  avalanche: "Avalanche USD (AVAX-USD)",
  avax: "Avalanche USD (AVAX-USD)",
  polkadot: "Polkadot USD (DOT-USD)",
  ...
  robin: "Robinhood Markets Inc. (HOOD)",
