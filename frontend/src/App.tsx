    ...
    <section className="analyzer-loading-panel surface-panel rounded-[2rem] p-5 sm:p-7">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h3 className="mt-2 text-2xl text-slate-900 dark:text-white sm:text-3xl">
        ...
        <div className="surface-panel relative overflow-hidden rounded-[2.8rem] p-6 sm:p-8 lg:p-10">
          <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="order-last space-y-6 lg:order-first">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#101114] text-white dark:bg-white dark:text-black">
              ...
              <div>
                ...
                <h1 className="mt-3 max-w-3xl text-3xl leading-none text-slate-900 dark:text-white sm:text-5xl lg:text-6xl">
          ...
          <div className="app-shell app-shell-header app-shell-header-compact rounded-[1.4rem] px-3 py-2.5 sm:rounded-[1.7rem] sm:px-4">
            <div className="grid items-center gap-3 lg:grid-cols-[minmax(12rem,1fr)_auto_max-content]">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  <div className="truncate text-[11px] font-extrabold uppercase tracking-[0.24em] text-slate-500 dark:text-slate-400">
                    Broker Freund
                  </div>
                ...
                {NAV_ITEMS.map((item) => (
                  <button
                    ...
                    className={`rounded-[0.85rem] px-3 py-2 text-xs font-bold transition-all ${
                      activeTab === item.id
                        ? "bg-[#101114] text-white shadow-[0_10px_30px_rgba(17,24,39,0.18)] dark:bg-white dark:text-black dark:shadow-[0_10px_30px_rgba(255,255,255,0.12)]"
                        : "text-slate-600 hover:bg-black/[0.04] hover:text-slate-900 dark:text-slate-400 dark:hover:bg-white/10 dark:hover:text-white"
                    }`}
                  >
                    {item.label}
                  </button>
                ...
                <div className="hidden rounded-[1.1rem] bg-[var(--bg-elevated)] p-1 ring-1 ring-[var(--line-subtle)] sm:flex">
                  <button
                    ...
                    className={`rounded-[0.9rem] px-3 py-2 text-xs font-extrabold uppercase tracking-[0.18em] transition-all ${
                      currency === "USD" ? "bg-[#101114] text-white dark:bg-white dark:text-black" : "text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-white"
                    }`}
                  >
                    USD
                  </button>
                  <button
                    ...
                    className={`rounded-[0.9rem] px-3 py-2 text-xs font-extrabold uppercase tracking-[0.18em] transition-all ${
                      currency === "EUR" ? "bg-[#101114] text-white dark:bg-white dark:text-black" : "text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-white"
                    }`}
                  >
                    EUR
                  </button>
      ...
      >
        ...
        {activeTab === "dashboard" ? (
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="rounded-[0.9rem] border border-black/10 bg-white px-3 py-2 text-xs font-extrabold uppercase tracking-[0.14em] text-slate-600 dark:border-white/10 dark:bg-white/10 dark:text-slate-200 dark:hover:bg-white/15"
                    >
                      Später
                    </button>
                  </div>
            ...
            <section className="surface-panel dashboard-command-panel dashboard-guide-panel hidden rounded-[1.5rem] p-4 sm:block sm:p-5">
              <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_auto] xl:items-center">
                <div className="min-w-0">
                  ...
                  <h2 className="mt-1 max-w-4xl text-2xl text-slate-900 dark:text-white sm:text-3xl">
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-2">
                    ...
                    {globalBrief?.macro_regime ? (
                      <div className="rounded-full border border-amber-500/20 bg-amber-500/10 px-2.5 py-1 text-[10px] font-extrabold uppercase tracking-[0.14em] text-amber-700 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-400">
                        Regime {macroRegimeLabel}
                      </div>
                    ) : null}
                  </div>
          ...
          <>
            ...
            {searchResolution && (
              <div className="surface-panel mb-8 flex flex-wrap items-center justify-between gap-3 rounded-[1.35rem] border border-emerald-500/18 bg-emerald-500/[0.06] px-4 py-3 text-sm text-emerald-900 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-300">
                <div>
                  <span className="font-extrabold">Aufgelöst:</span>{" "}
                  <span className="text-emerald-800 dark:text-emerald-300">{searchResolution.query}</span>{" "}
                  <span className="text-emerald-700 dark:text-emerald-400">{"->"}</span>{" "}
                  <span className="font-black text-emerald-950 dark:text-white">{searchResolution.ticker}</span>
                  {searchResolution.name ? (
                    <span className="text-emerald-800 dark:text-emerald-300"> / {searchResolution.name}</span>
                  ) : null}
                </div>
                <span className="rounded-full border border-emerald-500/20 bg-white/70 px-2.5 py-1 text-[10px] font-extrabold uppercase tracking-[0.14em] text-emerald-700 dark:border-emerald-500/30 dark:bg-emerald-500/15 dark:text-emerald-300">
            ...
            {!analysis && !loading && !error && (
              <section className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
                <div className="surface-panel rounded-[2rem] p-6">
                  ...
                  <h3 className="mt-3 text-2xl text-slate-900 dark:text-white">
          ...
          <ErrorBoundary>
            ...
            {needsRestore && cachedPortfolios.length > 0 && (
              <div className="mb-4 rounded-[1.4rem] border border-amber-400/30 bg-amber-50 p-5 shadow-sm dark:border-amber-500/30 dark:bg-amber-500/10">
                <div className="flex flex-wrap items-start gap-4">
                  <div className="flex-1">
                    <div className="text-sm font-extrabold text-amber-800 dark:text-amber-300">Portfolios wiederherstellen</div>
                    ...
                    <div className="mt-1 text-xs text-amber-600 dark:text-amber-400/80">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="rounded-[0.9rem] border border-amber-300 bg-white px-4 py-2 text-xs font-extrabold uppercase tracking-[0.14em] text-amber-700 hover:bg-amber-50 dark:border-white/10 dark:bg-white/10 dark:text-amber-300 dark:hover:bg-white/15"
                    >
                      Verwerfen
                    </button>
                  </div>
            ...
            <button
              ...
              className={`mobile-tabbar-button rounded-[0.95rem] px-1.5 py-2.5 text-center text-[9px] font-extrabold uppercase tracking-[0.12em] transition-all ${
                activeTab === item.id
                  ...
                  : "text-slate-500 hover:bg-black/[0.04] dark:text-slate-400 dark:hover:bg-white/10 dark:hover:text-white"
              }`}
            >
              {item.short}
            </button>
