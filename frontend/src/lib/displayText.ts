...
const ANALYSIS_TEXT: Record<string, string> = {
  ...
  "solid fundamentals with some positive aspects": "Solide Fundamentaldaten mit einigen positiven Aspekten",
  "mixed fundamentals - neither clearly cheap nor expensive": "Gemischte Fundamentaldaten – weder klar günstig noch eindeutig teuer",
  "weak fundamentals - several concerns": "Schwache Fundamentaldaten mit mehreren Warnsignalen",
  "poor fundamentals - significant risks present": "Sehr schwache Fundamentaldaten mit erheblichen Risiken",
  "earnings expectation data unavailable; recommendation relies on fundamentals, price and risk.": "Ergebnis- und Schätzungsdaten fehlen; die Einordnung stützt sich daher auf Fundamentaldaten, Kursentwicklung und Risiko.",
  "earnings quality supports a stronger buy/accumulate case.": "Die Ergebnisqualität stützt eine positivere Einstufung zum Kaufen oder Aufbauen.",
  "earnings quality weakens the buy case; wait for repair or guidance confirmation.": "Die Ergebnisqualität schwächt den positiven Investmentfall; auf eine Verbesserung oder einen bestätigten Ausblick warten.",
  "earnings quality is mixed or in line; do not upgrade without price confirmation.": "Die Ergebnisqualität ist gemischt oder erwartungsgemäß; ohne Kursbestätigung nicht höher einstufen.",
  "generally positive news flow from verified sources": "Überwiegend positive Nachrichtenlage aus verifizierten Quellen",
  "positive news sentiment identified": "Positive Nachrichtenstimmung erkannt",
  "negative news sentiment - monitor closely (verified alerts present)": "Negative Nachrichtenstimmung – eng beobachten, verifizierte Warnmeldungen liegen vor",
  "caution: negative news sentiment detected": "Vorsicht: Negative Nachrichtenstimmung erkannt",
  "exceptional growth potential identified": "Außergewöhnliches Wachstumspotenzial erkannt",
  "moderate growth potential": "Moderates Wachstumspotenzial",
  "limited growth catalysts": "Begrenzte Wachstumstreiber",
  "high probability rebound candidate": "Kandidat mit hoher Wahrscheinlichkeit für eine Kurserholung",
  "speculative rebound": "Spekulative Erholungschance",
  "no rebound setup detected": "Kein belastbares Erholungsszenario erkannt",
