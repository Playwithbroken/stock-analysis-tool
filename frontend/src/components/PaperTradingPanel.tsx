                ...
                <div key={item.setup_type} className="rounded-[1.3rem] border border-black/8 bg-white/75 p-4">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <div className="mt-1 text-xs text-slate-500">{item.trades} closed trades · Journal {item.journal_completion_rate ?? 100}%</div>
                      <div
                      ...
                      >
                        {item.quality_status || "building_evidence"}
                      </div>
                    </div>
                    <div className="text-right">
                  ...
                  <div className="mt-3 rounded-xl border border-black/8 bg-white/80 px-3 py-2 text-xs font-semibold text-slate-700">
                    {item.next_action || "Collect more paper evidence before changing risk."}
                  </div>
                </div>
              ))
            ) : (
